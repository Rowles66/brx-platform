...
export const PasswordField: React.FC<PasswordFieldProps> = ({
  ...
  const EyeIcon = () => (
    <svg
      aria-hidden="true"
      focusable="false"
      className="svg-inline--fa fa-eye fa-fw css-1m6suu7"
      role="img"
  ...
  return (
    <FormField
      ...
      endAdornment={
        <InputAdornment position="end" className="css-x0cmy">
          <IconButton
            onClick={handleTogglePassword}
            edge="end"
            aria-label={showPassword ? 'Hide password' : 'Show password'}
            // TODO: Add proper focus styling
            // TODO: Add proper ripple effect
          >
            <EyeIcon />
          </IconButton>
        </InputAdornment>
